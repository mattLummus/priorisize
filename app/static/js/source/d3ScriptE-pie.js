...
(function(){
  ...
  function prepInit(){
    ...
    prepData = [timeL, timeE, wkF, wkN, dT, dC, priF, priN];
    initPie(prepData, left, elapsed, wkFill, dependents, dependencies, priFill);
  }


  function initPie(pieData, left, elapsed, wkFill, dependents, dependencies, priFill){
    var data = pieData;
    var r = 75;
